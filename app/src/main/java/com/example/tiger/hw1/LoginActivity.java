...
//            //login, if you remember email-password
...
//                        try {
//                            response= HttpsProvider.getInstance().post("{\"email\": \""+mEmail+"\",\"password\": \""+mPassword+"\"}"
//                                    ,"/login");
//                        } catch (IOException e) {
//                            e.printStackTrace();
//                        }
...
//            }
        ...
        protected void onPostExecute(Response response) {
            ...
            if (response == null)
                Toast.makeText(LoginActivity.this, "Smth went wrong. You are not registered.", Toast.LENGTH_SHORT).show();
            else {
                switch (response.getResponseCode()) {
                    case 401:
                        ...
                        break;
                    case 409:
                        Toast.makeText(LoginActivity.this, "User exist. You are logging in.", Toast.LENGTH_SHORT).show();
